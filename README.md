...
- 📍**첫째**, **검색어의 상태를 다루는** 부분(전역상태관리의 필요성과 리액트쿼리의 쿼리키)
...
- 📍둘째, 뷰파트에 대한 이해의 측면(**InterserctionObserver, 이전라우터의 스크롤 위치 기억**)
